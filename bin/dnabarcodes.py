...
parser.add_argument('-cfgfile', metavar='FILENAME', type=argparse.FileType('rb'), help='the configuration file')

parser.add_argument('-minQ','--min_quality', action='store',type=float,metavar='FLOAT', help='minimum acceptable base quality')
...
def main():
	if args.cfgfile:
		cfg=dbcodeConfig.read(args.cfgfile)
	else:
